...
export const COMMAND_RESPONSES = {
  ...
  projects:
    "This project is just the tip of the iceberg! You’ll find more of my work over on LinkedIn. For the full scoop, hit the contact command and I’ll fill you in.",
  easteregg:
